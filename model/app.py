...
def predict():
    ...
    print(data)
    allergiesList = list(data.get("selectedAllergies"))
    print(type(allergiesList))

    foods_with_allergens = get_foods_with_allergens(allergiesList)
    print("Foods containing allergens:", foods_with_allergens)

    body = {}
    data = {}

    data["foods"] = list(foods_with_allergens)
    body["data"] = data
